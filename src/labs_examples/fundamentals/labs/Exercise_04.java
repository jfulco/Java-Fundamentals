...
public class Exercise_04 {
    ...
    public static void main(String[] args) {
        ...
        byte byteVal = 23;
        System.out.println("byte byteVal is: " + byteVal);

        short shortVal = 343;
        System.out.println("short shortVal is: " + shortVal);

        int intVal = 5677756;
        System.out.println("int intVal is: " + intVal);

        long longVal = 4567854432L;
        System.out.println("long longVal is: " + longVal);

        float floatVal = 34324.2f;
        System.out.println("float floatVal is: " + floatVal);

        double doubleVal = 908788328.2123;
